...
end_list =      ['2020-09-30T23:59:59.000Z',
                 ...
                 '2021-07-31T23:59:59.000Z',
                 '2021-08-31T23:59:59.000Z',
                 '2021-09-30T23:59:59.000Z',
...
# Create file
csvFile = open("data_set_2.csv", "a", newline="", encoding='utf-8')
csvWriter = csv.writer(csvFile)
        ...
        while flag:
            ...
            if 'next_token' in json_response['meta']:
                ...
                if result_count is not None and result_count > 0 and next_token is not None:
                    ...
                    append_to_csv(json_response, "data_set_2.csv")
                    count += result_count
...
df_2 = pd.read_csv('data_set_2.csv')
...
df_2['clean_tweet'] = df_2.tweet.apply(clean_tweet)

def remove_stopwords(tweets):
    return [[word for word in simple_preprocess(tweet) if word  not in stopwords_he] for tweet in tweets]
df_2['no_token_stop'] = remove_stopwords(df_2['clean_tweet'])


# remove duplicates
df_2 = df_2.drop_duplicates(subset=['clean_tweet'], keep='first')

# remove retweets
df_2 = df_2[df_2["clean_tweet"].str.contains("rt") == False]

# remove stopwords
pat = r'\b(?:{})\b'.format('|'.join(stopwords_he))
df_2['clean_no_stops'] = df_2['clean_tweet'].str.replace(pat, '')

# remove emoji
df_2['clean_no_stops'] = df_2['clean_no_stops'].str.replace('[^\w\s#@/:%.,_-]', '', flags=re.UNICODE)

#remove \n
df_2.replace(to_replace=[r"\\t|\\n|\\r", "\t|\n|\r"], value=["",""], regex=True, inplace=True)
